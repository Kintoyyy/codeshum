...
app.use(cors({ origin: process.env.FRONTEND_URL || 'http://frontend:3000' }));
...
server.listen(PORT, () => {
    console.log(`Frontend is running on ${process.env.FRONTEND_URL || 'http://frontend:3000'}`);
    console.log(`Backend is running on http://backend:5000`);
    // connectToDatabase();
});
